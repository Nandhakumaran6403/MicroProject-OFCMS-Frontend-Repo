    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 ml-64 p-6">
        ...
        <div className="w-full h-screen flex flex-col items-center bg-gray-100">
          <div className="max-w-7xl w-full p-6 bg-white rounded-lg shadow-md mt-6">
            <div className="flex justify-between items-center mb-4">
              <Link to="/employeemain" className="flex items-center text-blue-500 hover:underline hover:text-blue-700 transition-colors duration-300">
                ...
                {currentLogs.map((log) => (
                  <tr key={log.logId} className="hover:bg-gray-50 transition-colors duration-300">
                    ...
                    <td className="border border-gray-300 p-3">
                      <Link to={`/auditlogview/${log.logId}`} className="text-blue-500 hover:underline hover:text-blue-700 transition-colors duration-300">
                        View
                      </Link>
                    </td>
                  </tr>
